package org.example.dexreader.parsers.ksp
...
class ParserProcessor(
	...
	override fun process(resolver: Resolver): List<KSAnnotated> {
		val symbols = resolver
			.getSymbolsWithAnnotation("org.example.dexreader.parsers.MangaSourceParser")
		...
		val factoryFile = try {
			codeGenerator.createNewFile(
				...
				packageName = "org.example.dexreader.parsers",
		...
		val sourcesFile = try {
			codeGenerator.createNewFile(
				dependencies = dependencies,
				packageName = "org.example.dexreader.parsers.model",
