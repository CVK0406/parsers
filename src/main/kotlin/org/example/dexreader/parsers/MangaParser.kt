...
import org.example.dexreader.parsers.network.OkHttpWebClient
import org.example.dexreader.parsers.network.UserAgents
import org.example.dexreader.parsers.network.WebClient
import org.example.dexreader.parsers.util.FaviconParser
import org.example.dexreader.parsers.util.RelatedMangaFinder
...
abstract class MangaParser @InternalParsersApi constructor(
	...
	@Deprecated(
		...
		ReplaceWith(
			...
			"org.example.dexreader.parsers.model.MangaListFilter",
		),
	)
